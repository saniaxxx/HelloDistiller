...
void ScanKbd()
{
    ...
    if (CountKeys == 0) {
        ...
        if (digitalRead(PIN_RIGHT) == 0 && digitalRead(PIN_LEFT) == 0)
            KeyCode = KEYCODE_INIT_LCD;
        if (digitalRead(PIN_UP) == 0 && digitalRead(PIN_DOWN) == 0)
            KeyCode = KEYCODE_NEXT_STAGE;
#endif
        ...
        if (PRESS_RIGHT) {
            ...
            case 0:
                ...
                do {
                    if (++DispPage > SCREEN_ITEMS - 1)
                        DispPage = 0; // зацикливаем поиск
        ...
        if (PRESS_LEFT) {
            ...
            case 0:
                ...
                do {
                    if (--DispPage < 0)
                        DispPage = SCREEN_ITEMS - 1; // зацикливаем поиск
                } while (!screenEnableFlag[DispPage]);
            ...
            case 129:
                ...
                if (menuFlagNumber == 29)
                    menuFlagNumber = MENU_ITEMS - 2;
        ...
        if (PRESS_UP) {
            ...
            case 0:
                ...
                if (IspReg == 115) {
                    CountKeys = 2;
                    if (DispPage == 0)
                        timerMinute += AddPressKeys;
                    else
                        PowerMinute += AddPressKeys10;
                }
            ...
            case 249:
                ...
                break;
            case 257:
                if (CountFractionDist < MAX_CNT_FRACTION_DIST)
                    CountFractionDist++;
                CountKeys = 3;
                break;
            case 258:
                if (CountFractionRect < MAX_CNT_FRACTION_RECT)
                    CountFractionRect++;
                CountKeys = 3;
                break;
            case 259:
            ...
            case 312:
                if (nPopr == MAX_CNT_FRACTION_DIST) {
                    ...
                    CountKeys = 2;
                    if (flPopr == 0)
                        TempFractionDist[nPopr] += AddPressKeys;
                    if (flPopr == 2)
                        PowerFractionDist[nPopr] += AddPressKeys10;
                    if (flPopr == 1) {
            ...
            case 313:
                if (nPopr == MAX_CNT_FRACTION_RECT) {
                    ...
                    CountKeys = 2;
                    if (flPopr == 0)
                        TempFractionRect[nPopr] += AddPressKeys;
                    if (flPopr == 1) {
...
#if ENABLE_SENSOR_SORTING
            case 316:
                if (ds1820_nums[nPopr] < MAX_DS1820 - 1)
                    ds1820_nums[nPopr]++;
                CountKeys = 4;
                break;
#endif
        ...
        if (PRESS_DOWN) {
            ...
            case 249:
                ...
                break;
            case 257:
                if (CountFractionDist >= 0)
                    CountFractionDist--;
                CountKeys = 3;
                break;
            case 258:
                if (CountFractionRect >= 0)
                    CountFractionRect--;
                CountKeys = 3;
                break;
            case 259:
