...
void ProcessTestKLP()
{
    ...
    case 1: // Начало процесса
        ...
        if (SIMPLED_VERSION == 0 || SIMPLED_VERSION >= 5)
            ...
            ProcChimSR = 4; // Если используется простая версия, то ШИМ всегда 50%, а процент ШИМ-Это номер тестируемого в данный момент клапана.
    ...
    case 2: // Клапана открыты
        ...
        } else { // В упрощенной версии тестируем клапана по-очереди
